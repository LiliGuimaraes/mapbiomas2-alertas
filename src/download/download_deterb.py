...
DS_NAME="baseline/DETERB-AMAZONIA.shp"
DS_CON_ALERTS='PG:dbname=mapbiomas_alertas host=localhost user=postgres'

ALERTS_SOURCE='DETERB-AMAZONIA'
ALERTS_TMP_TABLE="consolidated_alerts_tmp_deterb"
...
for input_feature in input_layer:
	feature_date_str = input_feature.GetField("DATE")
	...
	new_alert_feature.SetField('detection_date', input_feature.GetField("DATE"))
